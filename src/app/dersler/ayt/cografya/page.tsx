...
export default function AytCografyaPage() {
  ...
  const topics: Topic[] = [
    {
      ...
      color: "#007AFF",
      subTopics: [
        { id: "cografya-kavramlari", title: "Coğrafya Kavramları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "fiziki-cografya", title: "Fiziki Coğrafya", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "iklim-iklim-tipleri", title: "İklim ve İklim Tipleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "dogal-bitkiler", title: "Doğal Bitkiler", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "toprak-tipleri", title: "Toprak Tipleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "dunya-nufusu", title: "Dünya Nüfusu", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "nufus-politikalari", title: "Nüfus Politikaları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "gocler", title: "Göçler", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "sehirlesme", title: "Şehirleşme", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "tarim", title: "Tarım", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "hayvancilik", title: "Hayvancılık", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "madencilik", title: "Madencilik", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "enerji-kaynaklari", title: "Enerji Kaynakları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "sanayi", title: "Sanayi", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "ulasim", title: "Ulaşım", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "ticaret", title: "Ticaret", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "turizm", title: "Turizm", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "cevre-sorunlari", title: "Çevre Sorunları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "dunya-ulkeleri", title: "Dünya Ülkeleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "turkiye-fiziki", title: "Türkiye'nin Fiziki Coğrafyası", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "turkiye-bolgeler", title: "Türkiye'nin Bölgeleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "turkiye-ekonomisi", title: "Türkiye'nin Ekonomik Coğrafyası", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    }
  ];
  ...
  const getOptimizedSearchQuery = (topicId: string): string => {
    const searchQueries: Record<string, string> = {
      "cografya-kavramlari": "AYT coğrafya kavramları",
      "fiziki-cografya": "AYT coğrafya fiziki coğrafya",
      "iklim-iklim-tipleri": "AYT coğrafya iklim iklim tipleri",
      "dogal-bitkiler": "AYT coğrafya doğal bitkiler",
      "toprak-tipleri": "AYT coğrafya toprak tipleri",
      "dunya-nufusu": "AYT coğrafya dünya nüfusu",
      "nufus-politikalari": "AYT coğrafya nüfus politikaları",
      "gocler": "AYT coğrafya göçler",
      "sehirlesme": "AYT coğrafya şehirleşme",
      "tarim": "AYT coğrafya tarım",
      "hayvancilik": "AYT coğrafya hayvancılık",
      "madencilik": "AYT coğrafya madencilik",
      "enerji-kaynaklari": "AYT coğrafya enerji kaynakları",
      "sanayi": "AYT coğrafya sanayi",
      "ulasim": "AYT coğrafya ulaşım",
      "ticaret": "AYT coğrafya ticaret",
      "turizm": "AYT coğrafya turizm",
      "cevre-sorunlari": "AYT coğrafya çevre sorunları",
      "dunya-ulkeleri": "AYT coğrafya dünya ülkeleri",
      "turkiye-fiziki": "AYT coğrafya türkiye fiziki",
      "turkiye-bolgeler": "AYT coğrafya türkiye bölgeleri",
      "turkiye-ekonomisi": "AYT coğrafya türkiye ekonomisi"
    };

    return searchQueries[topicId] || `AYT coğrafya ${topicId}`;
  };
