...
export default function AytEdebiyatPage() {
  ...
  const topics: Topic[] = [
    {
      ...
      color: "#8b5cf6",
      subTopics: [
        { id: "edebiyat-kavramlari", title: "Edebiyat Kavramları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "edebi-turler", title: "Edebi Türler", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "edebi-akimlar", title: "Edebi Akımlar", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "siir-bilgisi", title: "Şiir Bilgisi", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "nazim-birimleri", title: "Nazım Birimleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "nazim-turleri", title: "Nazım Türleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "divan-siiri", title: "Divan Şiiri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "halk-siiri", title: "Halk Şiiri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "tanzimat-siiri", title: "Tanzimat Şiiri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "servet-i-funun-siiri", title: "Servet-i Fünun Şiiri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "milli-edebiyat-siiri", title: "Milli Edebiyat Şiiri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "cumhuriyet-siiri", title: "Cumhuriyet Şiiri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "hikaye", title: "Hikaye", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "roman", title: "Roman", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "tiyatro", title: "Tiyatro", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "deneme", title: "Deneme", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "elestiri", title: "Eleştiri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "dil-ve-anlatim", title: "Dil ve Anlatım", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "tahlil", title: "Tahlil", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "retorik", title: "Retorik", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    }
  ];
  ...
  const getOptimizedSearchQuery = (topicId: string): string => {
    const searchQueries: Record<string, string> = {
      "edebiyat-kavramlari": "AYT edebiyat kavramları",
      "edebi-turler": "AYT edebiyat edebi türler",
      "edebi-akimlar": "AYT edebiyat edebi akımlar",
      "siir-bilgisi": "AYT edebiyat şiir bilgisi",
      "nazim-birimleri": "AYT edebiyat nazım birimleri",
      "nazim-turleri": "AYT edebiyat nazım türleri",
      "divan-siiri": "AYT edebiyat divan şiiri",
      "halk-siiri": "AYT edebiyat halk şiiri",
      "tanzimat-siiri": "AYT edebiyat tanzimat şiiri",
      "servet-i-funun-siiri": "AYT edebiyat servet-i fünun şiiri",
      "milli-edebiyat-siiri": "AYT edebiyat milli edebiyat şiiri",
      "cumhuriyet-siiri": "AYT edebiyat cumhuriyet şiiri",
      "hikaye": "AYT edebiyat hikaye",
      "roman": "AYT edebiyat roman",
      "tiyatro": "AYT edebiyat tiyatro",
      "deneme": "AYT edebiyat deneme",
      "elestiri": "AYT edebiyat eleştiri",
      "dil-ve-anlatim": "AYT edebiyat dil ve anlatım",
      "tahlil": "AYT edebiyat tahlil",
      "retorik": "AYT edebiyat retorik"
    };

    return searchQueries[topicId] || `AYT edebiyat ${topicId}`;
  };
  ...
  const selectTopic = async (topicId: string) => {
    ...
    if (currentSubTopic) {
      ...
      try {
        ...
        console.log(`📦 Cache kontrol ediliyor: ayt-edebiyat - ${topicId}`);
        const cachedVideos = await getCachedVideos('ayt-edebiyat', topicId);
