...
export default function AytBiyolojiPage() {
  ...
  const selectTopic = async (topicId: string) => {
    ...
    if (currentSubTopic) {
      gtag.trackTopicSelect(currentSubTopic.title, "AYT Biyoloji");
      ...
      try {
        ...
        console.log(`📦 Cache kontrol ediliyor: ayt-biyoloji - ${topicId}`);
        const cachedVideos = await getCachedVideos('ayt-biyoloji', topicId);
  ...
  const markTopicComplete = (topicId: string) => {
    ...
    if (!isAlreadyCompleted) {
      const currentSubTopic = getCurrentSubTopicById(topicId);
      if (currentSubTopic) {
        gtag.trackTopicComplete(currentSubTopic.title, "AYT Biyoloji");
      }
    }
  };
          ...
          <div className="lg:flex lg:min-h-[600px]">
            ...
            <div className="w-full lg:w-[30%] flex justify-center px-3 lg:px-0">
              <div id="tour-topics-panel" className="lg:sticky lg:top-40 w-full max-w-xs lg:max-w-xs">
                ...
                <Link href="/istatistikler?subject=AYT Biyoloji#ayt" className="block mb-4">
                  <button
